document.addEventListener("DOMContentLoaded", async () => {
  ...
  menuImg.src =
    "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAYUlEQVR4nO3WyQnAMAwFUZcXp/+zDMF9TDrQJcYLmdfBRwimFEmSBgFuoLG/BtRsyMM5+i+GVCDYXwDX51+SJEmaCDN+iZ5dxIyfLMx4SZJ0Gsz4JXp2ETN+sjDjJUlloBfbFyzbu4GNjwAAAABJRU5ErkJggg==";

  menuImg.alt = "Open-Drawer";

  menuButton.appendChild(menuImg);
  const mobileContainer = document.querySelector(
    ".mobile-headers-content-right"
  );

  const mobileImg = document.createElement("img");

  mobileImg.src =
    "data:image/png;base64,";

  mobileImg.alt = "Cart";

  mobileContainer.appendChild(mobileImg);

  const container = document.querySelector(".headers-content-right");
...
/*Sorting Function*/
  ...
  const updateContent = () => {
    ...
    if (filteredProducts.length === 0) {
      ...
      if (resultCountMob) {
        resultCountMob.textContent = "0 products";
      }
